...
List<Hardware> hardwareFromJson(String str) => List<Hardware>.from(json.decode(str).map((x) => Hardware.fromJson(x)));

String hardwareToJson(List<Hardware> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class Hardware {
    ...
    factory Hardware.fromJson(Map<String, dynamic> json) => Hardware(
        ...
        contenido: json["contenido"] == null ? null : Contenido.fromJson(json["contenido"]),
